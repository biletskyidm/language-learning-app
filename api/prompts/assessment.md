...
{{targets}}
{{#tutorMessage}}The tutor just said: {{tutorMessage}}
{{/tutorMessage}}Student message: {{userContent}}
Score contextCorrectness, grammarAndSyntax, vocabularyDiversity, sentenceComplexity, sentenceNaturalness 0-10. contextCorrectness judges whether the message answers what the tutor just said and fits the situation described in the context.
